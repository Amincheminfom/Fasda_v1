...
if uploaded_file:
    ...
    if 'Smiles' in data.columns:
        ...
        with col2:
            ...
            cbar.ax.set_yticklabels([str(i) for i in range(num_clusters)])  # Ensure labels are integers

            # Add logo below the colorbar
            box = OffsetImage(logo_img, zoom=0.05)  # Adjust zoom for proper size
            ab = AnnotationBbox(
                box,
                (0.97, -0.08),  # Adjust position (relative to colorbar)
